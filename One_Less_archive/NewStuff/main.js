...
const oneLiners = [
  ...
  '<li>It\'s fine to feel H-A-P-P-Y:  H-Having, A-All, P-People, P-Please, Y-You; Happiness is what happens to you<br>  But live in a state of J-O-Y:  J-Jesus, O-Others, Y-Yourself; Joy is your job ** </li><br><br>',
  ...
  '<li>Consider the this... Rather  than asikig God why something terrible happened to you<br>Ask God how that same thing can be used to glorify Him and bring you closer to Him</li><br><br>',
  '<li>My friend, You  need to "trust" the Power within  you more than "fear" the Power against you</li><br><br>',
  '<li>It\'s all about the ENDGAME! Don\'t focus on the diffulty of the task. Focus on how the success will bring Glory to God</li><br><br>,',
  '<li>Listen carefully my friend, Can you hear Jesus whispering from inside or do you hear Satan screaming from the outside.</li><br><br>',
  '<li>You can\'t hear the voice of God whispering to you because you are focused on Satan screaming at you</li><br><br>',
  '<li>Grace is God\'s unmerited favor.<br>Grace does God\'s uplifting of others.</li><br><br>',
  '<li>Disagreement in NOT hate...</li><br><br>,',
  '<li></li><br><br>,'
];
...
// $(".devotions").on('click', '.devoBtn5', function () {
//   $('.devoTestament').slideToggle();
// })
///////////////////// function to slide verses in  ONE SHEEP  ////////////////////////////////
// $("#IIcor5").hide();
...
/////////////////////////////////// Rotate Fingers on Praying Hands 45^ for Christian X ///////////////////////
...
//   rotate += 45;  // increase rotation with each click
//   $('.space-ship').css({
